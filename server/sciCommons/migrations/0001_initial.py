    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('type', models.CharField(choices=[('op', 'Open Article'), ('sb', 'Single Blinded'), ('db', 'Double Blinded')], default='op', max_length=20)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('members', models.ManyToManyField(blank=True, related_name='memberships', to='sciCommons.membership')),
            ],
        ),
        migrations.CreateModel(
            name='Comment',
        ...
        migrations.AddField(
            model_name='article',
            name='meta',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='sciCommons.articlemeta'),
        ),
        migrations.AddField(
            model_name='user',
            name='meta',
